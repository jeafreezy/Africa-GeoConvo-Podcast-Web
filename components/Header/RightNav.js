...
const RightNav=({open})=>{
    ...
    return( 
                <RightNavStyle open={open} id='rightnav'>
                    ...
                    <li><a href='https://twitter.com/Africageoconvo' target='_blank' rel='noopener noreferer'><img src='/static/assets/rss.png' width='25px' height='25px' title=''></img></a></li>
                    <li><a href='https://twitter.com/Africageoconvo' target='_blank' rel='noopener noreferer'><img src='/static/assets/spotify.png' width='27px' height='25px' title=''></img></a></li>
